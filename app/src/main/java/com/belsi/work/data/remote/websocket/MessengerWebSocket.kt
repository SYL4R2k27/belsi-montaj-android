...
class MessengerWebSocket @Inject constructor(
    ...
    private fun doConnect() {
        ...
        scope.launch {
            ...
            // FIX(security 2026-06-18): НЕ логировать URL с токеном (bearer-токен попадал в logcat
            // → перехват по ADB/bugreport/root). Логируем только базовый адрес без query.
            Log.d(TAG, "Connecting to $baseUrl/ws/messenger")
