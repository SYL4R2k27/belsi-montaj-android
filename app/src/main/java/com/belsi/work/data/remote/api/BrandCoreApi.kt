...
interface BrandCoreApi {
    ...
    // FIX(2026-05-22): возвращаем ResponseBody, а не Map<String,String> — generic Map
    // мог не десериализоваться kotlinx под R8. Тело ответа нам не нужно, важен лишь код.
    @POST("user/me/active-role")
    suspend fun setActiveRole(@Body body: SetActiveRoleIn): Response<okhttp3.ResponseBody>
