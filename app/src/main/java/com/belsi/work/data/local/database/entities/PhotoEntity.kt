...
data class PhotoEntity(
    ...
    // === v3 привязка (Куда отнести фото?) ===
    val windowId: String? = null, // site_object_windows.id — окно, к которому привязано фото
    val stage: String? = null, // karkas | podokonnik | ekran | general
    val isFinal: Boolean = false // финальное фото для приёмки
)
