...
data class StartPauseRequest(
    ...
    // FIX(2026-05-22) P0-1: реальное время старта (ISO-8601). Шлёт ТОЛЬКО offline-worker
    // при отложенном синке; онлайн-вызов оставляет null → сервер ставит NOW() (как раньше).
