...
data class ForemanTeamMemberDto(
    ...
    // Live статус: off / working / paused / idle
    @SerialName("shift_status") val shiftStatus: String = "off",
...
data class TeamMemberDto(
    ...
    /** Надёжное отображаемое имя: full_name гарантирован бэк-триггером; фолбэк на телефон. */
